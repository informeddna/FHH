    ...
    <table border="0" cellpadding="0" cellspacing="0" class="accordianTitlebarOpened" id="">
        ...
        <div class="accordianContent" id="ft">
			<table border="0" cellpadding="0" cellspacing="0" class="form" summary="<fmt:message key="form.familytree.table.summary"/>">
                ...
                <tr>
                    <th class="tdLabel"><label for="familyTreeForm_brothers" class="label"><fmt:message key="tree.form.relation.brothers" /></label></th>
                ...
                <tr>
                    <th class="tdLabel"><label for="familyTreeForm_sisters" class="label"><fmt:message key="tree.form.relation.sisters" /></label></th>
                ...
                <tr>
                    <th class="tdLabel"><label for="familyTreeForm_daughters" class="label"><fmt:message key="tree.form.relation.daughters" /></label></th>
