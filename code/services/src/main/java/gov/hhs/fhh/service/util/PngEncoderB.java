...
/**
 * PngEncoderB takes a Java BufferedImage object and creates a byte string which can be saved as a PNG file. The encoder
 * will accept BufferedImages with eight-bit samples or 4-byte ARGB samples.
 * 
 * <p>
 ...
 * 
 * <p>
 * Thanks to Jay Denny at KeyPoint Software <code>http://www.keypoint.com/</code> who let me develop this code on
 * company time.
 * </p>
 * 
 * <p>
 ...
 * the Free Software Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA 02111-1307 USA A copy of the GNU LGPL may
 * be found at <code>http://www.gnu.org/copyleft/lesser.html</code>
 * </p>
 * 
 ...
 *          Change private fields to protected fields so that PngEncoderB can inherit them (JDE) Fixed bug with
 *          calculation of nRows Added modifications for unsigned short images (contributed by Christian at xpogen.com)
 */
//CHECKSTYLE:OFF
@SuppressWarnings({"PMD.CyclomaticComplexity","PMD.UnusedLocalVariable","PMD.ExcessiveMethodLength","PMD.NPathComplexity"})
public class PngEncoderB extends PngEncoder {
    ...
    /**
     * Class constructor specifying BufferedImage source to encode, whether to encode alpha, filter to use, and
     * compression level
     * 
     * @param image A Java BufferedImage object
     * @param encodeAlpha Encode the alpha channel? false=no; true=yes
    ...
    public byte[] pngEncode(boolean encodeAlpha) {
        ...
        /*
         * start with an array that is big enough to hold all the pixels (plus filter bytes), and an extra 200 bytes for
         * header info
         */
    ...
    /**
     * Creates an array of bytes that is the PNG equivalent of the current image. Alpha encoding is determined by its
     ...
     * 
     * Sets number of output bytes per pixel, and, if only eight-bit bytes, turns off alpha encoding.
     * 
