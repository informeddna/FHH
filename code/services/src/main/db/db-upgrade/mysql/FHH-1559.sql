update code set status = 'INACTIVE' where codeName = '1000001' and status = 'ACTIVE';
...
update observation_code set observation_id = (select id from observation where name ='Rectal Cancer') where codes_id = (select id from code where codeName = '1000001');
