create table code (id bigint not null auto_increment, status varchar(255) not null, codeName varchar(255), codeSystem_id bigint, primary key (id));
create table codesystem (id bigint not null auto_increment, name varchar(255), version varchar(255), commonName varchar(255), primary key (id));
create table displayname (id bigint not null auto_increment, language varchar(255), text varchar(255), primary key (id));
create table displaystring (id bigint not null auto_increment, language varchar(50) not null, displayName varchar(255), appDisplay varchar(255), primary key (id));
