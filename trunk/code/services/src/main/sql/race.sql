...
insert into displaystring (id, appDisplay, displayName, language) values (260, 'Amerindio u nativo de Alaska', 'American Indian or Alaska Native', 'es');
insert into race_displaystring (Race_id, displayStrings_id) values (1, 260);

insert into race (id, originalText, subType) values (2, 'Asian', 'Race');
...
insert into race (id, originalText, subType) values (4, 'Native Hawaiian or Other Pacific Islander', 'Race');
