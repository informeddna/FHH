...
public final class FhhRegistry {
    ...
    /**
     * Gets the Messaging Service service from the service locator.
     * @return the service.
     */
    public static MessagingGatewayLocal getMessagingGatewayService() {
        return getInstance().getServiceLocator().getMessageGatewayService();
    }
    
    /**
     * Gets the HealthVault Service service from the service locator.
     * @return the service.
     */
    public static HealthVaultLocal getHealthVaultService() {
        return getInstance().getServiceLocator().getHealthVault();
    }
}