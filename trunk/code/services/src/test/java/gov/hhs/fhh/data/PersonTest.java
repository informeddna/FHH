...
public class PersonTest {
    ...
    public void testGetBmi() {
        ...
        p.setWeight(DUMMY_WEIGHT);
        double bmi = DUMMY_WEIGHT.getValue() * PersonUtils.US_BMI_NUMERATOR /
                (DUMMY_HEIGHT.getValue() * DUMMY_HEIGHT.getValue());
        ...
        bmi = DUMMY_WEIGHT.getValue() * 1.0 / (Math.pow(DUMMY_HEIGHT.getValue() / 100.0, 2));
        assertEquals(bmiDecimalFormat.format(bmi), p.getBmi());
    ...
    public void testRelationshipGraph2() {
        ...
        assertEquals(centeredOnHalfNephew.getRelativeByName("brother"), centeredOnHalfNephew
                .getRelativeByName("b1-kid")
                .getFather());
        assertEquals(centeredOnHalfNephew.getRelativeByName("sister"), centeredOnHalfNephew
                .getRelativeByName("s1-kid1")
                .getMother());
        assertEquals(centeredOnHalfNephew.getRelativeByName("sister"), centeredOnHalfNephew
                .getRelativeByName("s1-kid2")
                .getMother());
        assertEquals(centeredOnHalfNephew.getRelativeByName("sister"), centeredOnHalfNephew
                .getRelativeByName("s1-kid3")
                .getMother());
