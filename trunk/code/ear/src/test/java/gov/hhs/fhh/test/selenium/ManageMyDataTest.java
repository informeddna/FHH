 ...
 * 
 */
public class ManageMyDataTest extends AbstractPageSeleniumTest {
...
//                new VerifyPopulateNavigateActor(SaveFamilyHistoryPage.getInstance(selenium), new SpanishUpdatePedigreePageContent())));
//    }
