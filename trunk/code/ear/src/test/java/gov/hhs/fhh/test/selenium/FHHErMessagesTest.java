...
public class FHHErMessagesTest extends AbstractFHHSeleniumTest {
    ...
    public void TestErrors() throws Exception {
        ...
        selenium.click("personForm_0");
        waitForText("Feet must be a valid number greater than 0.");
        selenium.type("heightUnit1", "5");
        selenium.type("personForm_weightString", "1.2");
        selenium.click("personForm_0");
        waitForText("Weight must be a valid number greater than 0.");
        selenium.type("heightMetric", "1.1");
        selenium.type("heightUnit2", "2.4");
        selenium.click("personForm_0");
        waitForText("Centimeters must be a valid number greater than 0.");
        waitForText("Inches must be a valid number greater than 0");
        ...
        waitForText("Age must be a valid number greater than 0.");
    }
}