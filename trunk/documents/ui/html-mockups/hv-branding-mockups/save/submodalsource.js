	...
	popcont.innerHTML = '' +
		'<div id="popupInner">' +
			'<div id="popupTitleBar">' +
				...
				'</div>' +
			'</div>' +
			'<iframe src="'+gLoading+'" style="width:98%;height:98%;background-color:transparent;" scrolling="auto" frameborder="0" allowtransparency="true" id="popupFrame" name="popupFrame" width="98%" height="98%"></iframe>' +
		'</div>';
