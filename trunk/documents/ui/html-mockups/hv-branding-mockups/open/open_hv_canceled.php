			    ...
			    <div class="accordianContainer" id="saveFamilyHistory">
			        ...
			        <div class="accordianContent">
							...
							<div class="loginstatus">
								...
								<p>You cancelled connecting to HealthVault. You may open your information from a previously-saved file on your computer or try connecting to HealthVault again by selecting from the choices below. </p>
				        ...
				        <div class="box_noshade">
				        		...
				        		<div class="thumb"><img src="../images/ico_open_local.gif" alt="Open from Computer" /></div>
					        		...
					        		<div class="thumb_content">
										...
										<input type="file" name="file" id="file" size="37" />
						         ...
						         <hr />
					        		...
					        		<div class="thumb_content">
							        	...
							        	<h2>Copy from Microsoft&reg; HealthVault&trade;</h2>  	
					
										<p>Microsoft HealthVault lets you gather, store, and share health information online. My Family Health Portrait is
going to copy data from your HealthVault account and needs you to sign in.
</p><p>
When you choose to copy your family health history information from Microsoft HealthVault, please note that
your information will still be retained in HealthVault, and will be subject to the HealthVault terms of use and
privacy policy.</p>
										
								  <div class="buttonContainer">
						         		
						        			<div class="btn_float_right"><a href="hv_transition.php">Copy from HealthVault</a></div>
					           ...
					           <div class="buttonContainer">
						         	...
						         	<div class="buttonCentered"><a href="javascript:;" onclick="window.top.hidePopWin()">Cancel</a></div>
