        ...
        <div id="process_steps">
				...
				<div class="box_noshade">
					...
					<div class="box_float_inner">
						...
						<div class="thumb"><img src="../images/to_healthvault.gif" alt="Microsoft HealthVault" /></div>
					...
					<div class="box_hilite">
						...
						<ul>
							<li>Consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat</li>
							<li>volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in </li>
							<li>hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum.</li>
						</ul>
