	        ...
	        <div id="process_steps">
				...
				<div class="box_noshade">
					...
					<div class="thumb_content">
						...
						<h2>Save Your Family Health History to HealthVault Now</h2>
						
						<p>Note: your Family Health History information will now be saved to your HealthVault account.</p>
					...
					<div class="buttonContainer">
		         	...
		         	<div class="btn_right">
							<div class="btn_float"><a href="hv_success.php">Save</a></div>
