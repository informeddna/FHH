    ...
    <div class="accordianContainer" id="saveFamilyHistory">
        ...
        <div class="accordianContent">
				...
				<div class="loginstatus">
					...
					<p><strong>Status:</strong> John Smith is currently signed in to Microsoft HealthVault. </p>
	        ...
	        <div id="process_steps">
			  ...
			  <div class="thumb_content">
						...
						<h2>Copy Your Family Health History to HealthVault Now</h2>
						
						<p>Note: Your family health history information will now be copied to your HealthVault account.  You can copy it
back into My Family Health Portrait later to continue working with it.</p>
					...
					<div class="buttonContainer">
		         	...
		         	<div class="btn_right">
							<div class="btn_float"><a href="hv_success.php">Copy to HealthVault</a></div>
