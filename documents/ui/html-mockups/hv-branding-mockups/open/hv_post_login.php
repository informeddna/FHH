	            ...
	            <div class="submodalContainer">
			        ...
			        <div class="accordianContent">
						  ...
						  <div class="thumb_content">
									...
									<h2>Copy Your Family Health History</h2>
									
									<p>The following family health history information will be copied from HealthVault: </p>
								...
								<div class="buttonContainer">
					         	...
					         	<div class="btn_right" style="width:60%">
					         	
										<div class="btn_float" style="padding-right:40px;"><a href="loading.php">Copy from HealthVault</a></div>
