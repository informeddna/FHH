...
var PageName = 'submodal_Report Options';
var PageId = 'pab4d4d0d66b046e08795cc09b1aef04e'
var PageUrl = 'submodal_Report_Options.html'
document.title = 'submodal_Report Options';
...
if ((GetCheckState('u2')) == (false)) {

	SetPanelVisibilityu4("hidden");

	MoveWidgetBy('u12',0,-122);

	MoveWidgetBy('u21',0,-122);

}
else
if ((GetCheckState('u2')) == (true)) {
