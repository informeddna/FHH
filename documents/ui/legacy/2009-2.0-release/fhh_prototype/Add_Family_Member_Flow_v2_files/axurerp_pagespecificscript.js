...
var PageName = 'Add Family Member Flow_v2';
var PageId = 'pb4ad0b6590154ef1a72ec371635ff22c'
var PageUrl = 'Add_Family_Member_Flow_v2.html'
document.title = 'Add Family Member Flow_v2';
...
eval(GetDynamicPanelScript('u80', 1));
...
if (bIE) u87.attachEvent("onchange", Changeu87);
else u87.addEventListener("change", Changeu87, true);
function Changeu87(e)
{

if (((GetSelectedOption('u87')) == (PopulateVariables('Grandmother'))) || (((GetSelectedOption('u87')) == (PopulateVariables('Grandfather'))) || (((GetSelectedOption('u87')) == (PopulateVariables('Aunt'))) || (((GetSelectedOption('u87')) == (PopulateVariables('Uncle'))) || (((GetSelectedOption('u87')) == (PopulateVariables('Cousin'))) || (((GetSelectedOption('u87')) == (PopulateVariables('Niece'))) || ((GetSelectedOption('u87')) == (PopulateVariables('Nephew'))))))))) {

	var obj1 = document.getElementById("u80");
	if (obj1.style.visibility == "" || obj1.style.visibility == "visible") { SetPanelVisibilityu80("hidden"); }
	else {SetPanelVisibilityu80("");}

	var obj1 = document.getElementById("u98");
	if (obj1.style.visibility == "" || obj1.style.visibility == "visible") { SetPanelVisibilityu98("hidden"); }
	else {SetPanelVisibilityu98("");}

}
else
if (((GetSelectedOption('u87')) == (PopulateVariables('Granddaughter'))) || ((GetSelectedOption('u87')) == (PopulateVariables('Grandson')))) {
